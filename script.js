...
function calculate() {
    ...
    const extractedData = simulateDataExtraction(propertyLink);
...
function simulateDataExtraction(link) {
    // Remplacer cette fonction par une extraction réelle des données
    // Selon le format du site cible
    return {
